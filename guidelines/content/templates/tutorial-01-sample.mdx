...
📖 **Learn more**: [The Rust Book - Structs](https://doc.rust-lang.org/book/ch05-01-defining-structs.html)
</Aside>
...
Great! You just created your first Rust struct with a constructor. The test proves our code compiles and runs.
</Aside>
...
📖 **Learn more**: [The Rust Book - References and Borrowing](https://doc.rust-lang.org/book/ch04-02-references-and-borrowing.html)
</Aside>
...
📖 **Learn more**: [The Rust Book - Option](https://doc.rust-lang.org/book/ch06-01-defining-an-enum.html#the-option-enum-and-its-advantages-over-null-values)
</Aside>
...
<CardGrid>
  <Card title="Ready for More?" icon="rocket">
    **Next Tutorial**: Adding Persistence
    
    Learn how to save data to disk so it survives restarts!
  </Card>
  
  <Card title="Practice Challenges" icon="puzzle">
    1. Add a `delete()` method
    2. Add a `len()` method to count entries
    3. Make keys case-insensitive
  </Card>
</CardGrid>
